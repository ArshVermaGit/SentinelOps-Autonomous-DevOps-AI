...
def generate_mock_dashboard() -> dict:
    ...
    return {
        "repos": {"total": 4, "high_risk": 2, "avg_risk_score": 0.62},
        "ci": {"total_runs_30d": 156, "failed_runs_30d": 28, "success_rate": 82.1, "avg_build_time_ms": 145000},
        "incidents": {"open": 3, "total_30d": 8},
        "repos_list": [
